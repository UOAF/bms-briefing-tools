...
python .\scripts\render_bms_enemy_air_threat_map.py `
  ...
  --combined-objective-margin-grid 9 `
  --combined-objective-north-bound-label SA6 `
  --combined-objective-north-padding-nm 10 `
  --combined-objective-crop-top-fraction 0 `
  --combined-threat-opacity 0.26 `
  --combined-threat-style target-area `
  --scale 18
```
...
- `03_objective_area_map.png`: close objective-area map using the same combined
  content as the target-area map, with tighter objective-area crop framing.
